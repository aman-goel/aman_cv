...
\section{\mysidestyle Recent\\Research\\Experience}
    ...
    \phantom{xx}\hspace{3ex} (\href{http://fmv.jku.at/hwmcc20/}{HWMCC}) 2020
    ...
    \phantom{xx}\hspace{1ex} \href{https://github.com/SRI-CSL/yices2}{Yices 2} \\
    \phantom{xx}\hspace{1ex} -- A state-of-the-art SMT solver from \href{https://www.sri.com/}{SRI} \\
...
\section{\mysidestyle Recent\\Service}
    ...
    \phantom{x} \href{https://popl21.sigplan.org/home/VMCAI-2021}{\textbf{VMCAI'21}}: Conference on Verification, Model Checking, and Abstract Interpretation\\
    \phantom{x} \href{https://2020.splashcon.org/track/splash-2020-Artifacts}{\textbf{OOPSLA'20}}: Conference on Object-Oriented Programming Systems, Languages, and Apps\\
    \phantom{x} \href{http://i-cav.org/2020/}{\textbf{CAV'20}}: Conference on Computer-Aided Verification
